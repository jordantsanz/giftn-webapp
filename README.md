...
## Services
This app uses Google authentication and connects to [**giftn's** REST API](https://github.com/catherinedparnell/giftn-api) where it engages with Google Cloud Firestore database.
